                    ...
                    <div class="box_account">
                        <form action="functions/assinantes_adicionar.php" enctype="multipart/form-data"
                            ...
                            <div class="form_container">
                                ...
                                <div style="background-color: #9b111e; margin-bottom: 20px; padding-left: 5px; padding-top:5px; height: 30px; color:#fff; border-radius: 2px; width: 100%" class="alert alert-danger" role="alert">
                                   E-mail já cadastrado. Faça login ao lado.
                                </div>
                                <div class="form-group">
