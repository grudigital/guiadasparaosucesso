...
<div class="wrapper-page">
    ...
    <div class="m-t-40 text-center">
        <p class="text-white">© 2020 Guiadas para o sucesso <span class="text-muted d-none d-sm-inline-block float-right" style="color: #fff !important">Desenvolvido com <i class="mdi mdi-heart text-danger"></i> por Grudigital</span></p>
    </div>
