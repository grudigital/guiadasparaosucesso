                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li class="hide-phone list-inline-item app-search">
                            <h3 class="page-title">Painel de gerenciamento :: Anunciantes :: Editar imagem</h3>
                        </li>
                    </ul>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card m-b-20">
                                <form class="card-body" action="functions/anunciantes_imagem.php"
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-4">
                                                ...
                                                <p class="text-muted m-b-30 font-14">Editar imagem de anunciante</p>
                                            </div>
                                            <div class="col-6"></div>
                                            <div class="col-2">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            {
                                                echo "<img src='uploads/anunciantes/$row[imagem]' class='img-fluid'>";
                                                echo "<input type='hidden' name='id' value='$row[id]'>";
                                                echo "<br/><br/>";
                                            }
                                        }
