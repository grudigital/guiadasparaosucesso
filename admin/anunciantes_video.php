                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li class="hide-phone list-inline-item app-search">
                            <h3 class="page-title">Painel de gerenciamento :: Anunciantes :: Editar vídeo</h3>
                        </li>
                    </ul>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card m-b-20">
                                <form class="card-body" action="functions/anunciantes_video.php"
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-4">
                                                ...
                                                <p class="text-muted m-b-30 font-14">Editar vídeo de anunciante</p>
                                            </div>
                                            <div class="col-6"></div>
                                            <div class="col-2">
