                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li class="hide-phone list-inline-item app-search">
                            <h3 class="page-title">Painel de gerenciamento :: Blog :: Adicionar</h3>
                        </li>
                    </ul>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card m-b-20">
                                <form class="card-body" action="functions/blog_adicionar.php" enctype="multipart/form-data"
                                      method="post">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-4">
                                                <h4 class="mt-0 header-title">Blog</h4>
                                                <p class="text-muted m-b-30 font-14">Adicionar publicação</p>
                                            </div>
                                            <div class="col-6"></div>
                                            <div class="col-2">
                                    ...
                                    <?php
                                    $usuariopublicador = $_SESSION['usuarioId'];
                                    echo "<input type='hidden' value='$usuariopublicador' name='publicador'>";
                                    ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="resumo" id="descricao" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
