                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li class="hide-phone list-inline-item app-search">
                            <h3 class="page-title">Painel de gerenciamento :: Anunciantes</h3>
                        </li>
                    </ul>
                                ...
                                <div class="card-body">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-6"></div>
                                            <div class="col-2">
                                                <a href="anunciantes_adicionar.php">
                                    ...
                                    <div class="alert alert-danger" role="alert">
                                        Anunciante excluido com sucesso!
                                    </div>
                                    <?php include 'includes/anunciantes-listar.php' ?>
                                </div>
                            </div>
                        </div> <!-- end col -->
                    </div> <!-- end row -->
