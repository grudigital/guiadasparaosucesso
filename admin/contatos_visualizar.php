                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li class="hide-phone list-inline-item app-search">
                            <h3 class="page-title">Painel de gerenciamento :: Contatos :: Visualizar</h3>
                        </li>
                    </ul>
                        ...
                        <div class="col-12">
                            <div class="card m-b-20">
                                <form class="card-body" action="#"
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-4">
                                                ...
                                                <p class="text-muted m-b-30 font-14">Visualizar contatos vindos pelo site</p>
                                            </div>
                                            <div class="col-6"></div>
                                            <div class="col-2">
                                    ...
                                    $pegaid = (int)$_GET['id'];
                                    $sql = "select id,nome,telefone,email,mensagem,datacontato,status FROM contatos where id = '$pegaid'";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<div class='col-sm-10'>";
                                        echo "<p style='margin-top: 5px'>$row[datacontato]</p>";
                                        echo "</div>";
                                        echo "</div>";
