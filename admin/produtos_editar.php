                            ...
                            <div class="card m-b-20">
                                <form class="card-body" action="functions/produtos_editar.php"
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<div class='form-group row'>";
                                        echo "<label for='example-text-input' class='col-sm-2 col-form-label'>Link de pagamento</label>";
                                        echo "<div class='col-sm-10'>";
                                        echo "<input class='form-control' name='linkpagamento' type='text' value='$row[linkpagamento]'
                                                   id='example-text-input'>";
                                        echo "</div>";
                                        echo "</div>";

                                        echo "<div class='form-group row'>";
                                        echo "<label for='example-text-input' class='col-sm-2 col-form-label'>Preço novo</label>";
                                        echo "<div class='col-sm-10'>";
                                        echo "<input class='form-control' name='preconovo' type='text' value='$row[preconovo]'
                                                   id='example-text-input'>";
                                        echo "</div>";
                                        echo "</div>";

                                        echo "<div class='form-group row'>";
                                        echo "<label for='example-text-input' class='col-sm-2 col-form-label'>Preço antigo</label>";
                                        echo "<div class='col-sm-10'>";
                                        echo "<input class='form-control' name='precoantigo' type='text' value='$row[precoantigo]'
                                                   id='example-text-input'>";
                                        echo "</div>";
                                        echo "</div>";
