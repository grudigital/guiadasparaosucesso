        ...
        <form action="functions/orcamento_adicionar.php" enctype="multipart/form-data" method="post">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<div class='prod_options'>";
                 ...
                 echo "<div style='color:#155724; padding-top: 7px; border-radius: 5px; margin-bottom: 30px; padding-left:10px; height:40px; background-color:#d4edda; font-size:18px; border-bolor:#c3e6cb  ' class='alert alert-success' role='alert'>Orçamento enviado com sucesso. Entraremos em contato em instantes. </div>";
